    ...
    <footer className="bg-dark section">
      <div className="container mx-auto">
        ...
        className="text-white flex flex-col lg:flex-row lg: justify-between gap-x-5 gap-y-14">
          ...
          {/* program */}
          <motion.div 
          variants={fadeIn('up')}  className="flex-1">
          ...
          className="flex-1">
            ...
            <form action="submit" className="flex justify-between items-start border-b border-[#b6b6b6]">
              <input type="text" className="outline-none placeholder:text-base placeholder:capitalize bg-transparent pb-2" placeholder={newsletter.form.placeholder}/>
