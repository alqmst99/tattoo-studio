...
const About = () => {
  //destructure data
  const { title, subtitle1, subtitle2, btnIcon, btnText } = aboutData;
  return (
    <section className="lg:py-16 xl:pb-[160px]">
      <div className="container mx-auto">
        <div className=" flex flex-col lg:flex-row gapx-[70px] items-center">
          {/* numbers */}
          <motion.div
          ...
          >
            <div className="text-[360px] xl:text-[720] leading-none font-tertiary lg:-tracking-[0.055em] 
